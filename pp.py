...
def get_place_name(lat, lng):
    ...
    phone, website = get_place_details(place_id) if place_id else (None, None)

    return name, maps_link, (phone, website)

def get_place_details(place_id):
    """Fetch phone number and website using Place Details API"""
...
def main():
    ...
    name, link, (phone, website) = get_place_name(latitude, longitude)
